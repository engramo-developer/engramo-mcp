...
# mode runs as a local process with ENGRAMO_API_TOKEN, not a container.
#
...
# ENGRAMO_API_URL is required; MCP_PUBLIC_URL must be set to this service's own
